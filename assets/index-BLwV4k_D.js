...
void main() {
	...
	`}var Ds=class extends Xt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new ra([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
  ...
  `}var Vd={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = opacity * texel;
				...
				}`})}_getEdgeDetectionMaterial(){return new ga({uniforms:{maskTexture:{value:null},texSize:{value:new W(.5,.5)},visibleEdgeColor:{value:new G(1,1,1)},hiddenEdgeColor:{value:new G(1,1,1)}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getSeparableBlurMaterial(e){return new ga({defines:{MAX_RADIUS:e},uniforms:{colorTexture:{value:null},texSize:{value:new W(.5,.5)},direction:{value:new W(.5,.5)},kernelRadius:{value:1}},vertexShader:`varying vec2 vUv;
				...
				}`})}_getOverlayMaterial(){return new ga({uniforms:{maskTexture:{value:null},edgeTexture1:{value:null},edgeTexture2:{value:null},patternTexture:{value:null},edgeStrength:{value:1},edgeGlow:{value:1},usePatternTexture:{value:0}},vertexShader:`varying vec2 vUv;
				...
				}`,blending:2,depthTest:!1,depthWrite:!1,transparent:!0})}};Zd.BlurDirectionX=new W(1,0),Zd.BlurDirectionY=new W(0,1);var Qd={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},$d=class extends Hd{constructor(){super(),this.isOutputPass=!0,this.uniforms=pa.clone(Qd.uniforms),this.material=new _a({name:Qd.name,uniforms:this.uniforms,vertexShader:Qd.vertexShader,fragmentShader:Qd.fragmentShader}),this._fsQuad=new Gd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},q.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},ef,tf;function nf(e,t,n){ef=new Yd(e),e.outputColorSpace=Ve,ef.addPass(new Xd(t,n)),tf=new Zd(new W(window.innerWidth,window.innerHeight),t,n),tf.edgeThickness=2,tf.edgeStrength=30,tf.edgeColor=new Y(`#ff00ff`),ef.addPass(tf),ef.addPass(new $d)}function rf(e){tf.selectedObjects=[e]}function af(){ef.render()}var of=new Fn;of.background=new Y(2960685);var sf=new fo(75,window.innerWidth/window.innerHeight,.1,1e3);sf.position.set(0,2,5);var cf=new uu({antialias:!0});cf.setSize(window.innerWidth,window.innerHeight),document.getElementById(`viewport`).appendChild(cf.domElement),nf(cf,of,sf),cf.physicallyCorrectLights=!0,cf.toneMapping=4,cf.toneMappingExposure=1.5,of.environment=new vs(cf).fromScene(new Fd).texture;var lf=new bu(sf,cf.domElement);lf.enableDamping=!0;var uf=new bo(16777215,2);of.add(uf);var df=new yo(16777215,3);df.position.set(5,10,5),of.add(df);var ff=null;function pf(e){Bd(e),rf(e),gf=e,document.getElementById(`memo-input`).value=hf[e.name]||``;let t=new Xn().setFromObject(e).getCenter(new G);sf.position.set(t.x,t.y,t.z+.2),lf.target.copy(t),lf.update()}function mf(e){ff&&of.remove(ff),Ld(of,sf,lf,e,e=>{ff=e,Rd(e,pf)})}mf(`/potion.glb`),document.getElementById(`upload-btn`).addEventListener(`click`,()=>{document.getElementById(`file-input`).click()}),document.getElementById(`file-input`).addEventListener(`change`,e=>{let t=e.target.files[0];mf(URL.createObjectURL(t))});var hf={},gf=null;document.getElementById(`memo-input`).addEventListener(`input`,e=>{gf&&(hf[gf.name]=e.target.value)});var _f=!1;document.getElementById(`xray-btn`).addEventListener(`click`,()=>{_f=!_f,document.getElementById(`xray-btn`).classList.toggle(`active`)});var vf=!1;document.getElementById(`wire-btn`).addEventListener(`click`,()=>{vf=!vf,document.getElementById(`wire-btn`).classList.toggle(`active`),ff.traverse(e=>{e.isMesh&&(e.material.wireframe=vf)})});var yf=new Uo,bf=new W,xf=0;window.addEventListener(`click`,e=>{let t=document.getElementById(`viewport`).getBoundingClientRect();bf.x=(e.clientX-t.left)/t.width*2-1,bf.y=-((e.clientY-t.top)/t.height)*2+1,yf.setFromCamera(bf,sf);let n=yf.intersectObjects(of.children,!0);if(n.length>0){let e;_f?(xf%=n.length,e=n[xf].object,xf++):(e=n[0].object,xf=0),rf(e),Bd(e),gf=e,document.getElementById(`memo-input`).value=hf[e.name]||``;let t=new Xn().setFromObject(e);console.log(ff);let r=t.getCenter(new G),i=t.getSize(new G);Math.max(i.x,i.y,i.z),sf.position.set(r.x,r.y,r.z+.2),lf.target.copy(r),lf.update()}});function Sf(){requestAnimationFrame(Sf),lf.update(),af()}Sf(),window.addEventListener(`resize`,()=>{sf.aspect=window.innerWidth/window.innerHeight,sf.updateProjectionMatrix(),cf.setSize(window.innerWidth,window.innerHeight)});